    ...
    <div className='bg-primary-light mt-5 rounded text-base'>
        <div className='px-6 py-4 space-y-5'>
            ...
            <div className='px-4 mb-6'>
                ...
                items-center mb-4'><span className='mr-2'>
                    Clear Cart</span> <i className="ri-delete-bin-fill"></i>
                </button>

                <button className='bg-green-600 px-3 py-1.5 text-white mt-2 rounded-md flex justify-between
                items-center'><span className='mr-2'>
                    proceed Checkout</span> <i className="ri-bank-card-line"></i>
                </button>
            </div>
        </div>
    </div>
